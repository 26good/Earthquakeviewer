...
本アプリは Replit Agent と Anthropic の Claude（AI）を活用して開発されています。コードの大部分は作成者の指示のもとAIが生成・修正したものです。なので、バグや気になる点がある可能性があります。そのようなお気づきの点がありましたらこのリポジトリ上のIssuesまでお願いします。
